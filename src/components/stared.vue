    ...
    <div id="offCanvasWrapper" class="mui-off-canvas-wrap mui-draggable mui-slide-in">
      ...
      <div class="mui-inner-wrap">
        <header class="mui-bar mui-bar-nav" style="background-color: #007AFF;">
          ...
          <h1 class="mui-title" style="color: white;">已标星</h1>
        </header>
          ...
          <div class="mui-scroll">
            ...
            <ul class="mui-table-view">
            	<li class="mui-table-view-cell mui-media" v-for="(item,i) in mailList">
            		<!-- <a @tap="toDetail(item.id)"> -->
            			<!-- <img class="mui-media-object mui-pull-left" style="margin-right: 0px; width: 70px;" src="../../build/logo.png"> -->
                    ...
                    <img @tap="toDetail(i,item)" v-if="item.senderHeadImg != null && item.senderHeadImg != '' && item.senderHeadImg.length != 0" class="round_icon" :src="item.senderHeadImg">
                      ...
                      <span style="float: left; color: #8F8F94;" v-if="item.isRead == 2">{{item.subject}}</span>
            				...
            				<!-- <div class="mui-ellipsis" style="overflow: hidden; font-size: 18px; margin-left: 10px;"> -->
                      <!-- <span style="float: left;" v-if="item.isRead == 1">{{item.content}}</span>
                      <span style="float: left; color: #8F8F94;" v-if="item.isRead == 2">{{item.content}}</span>
                      <span style="float: right;color: #8F8F94;" class="mui-icon mui-icon-star"></span> -->
                      <div style="margin-left: 10px;">
                        ...
                        <div style="width: 10%;float: right;">
                          <span @tap="changeStar(i,item)" class="mui-icon mui-icon-star-filled" style="font-size: 19px;float: right;padding-right: 0px;"></span>
                        </div>
                      </div>
                    <!-- </div> -->
            			</div>
...
<script>
  export default {
    ...
    methods: {
      ...
      getStaredMails: function() {
        console.log('come in get stared mails')
